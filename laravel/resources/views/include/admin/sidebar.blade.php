 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
     <ul class="nav">
         ...
         <li class="nav-item">
             <a class="nav-link" href="/admin/recharge-history">
         ...
         <li class="nav-item">
             <a class="nav-link" href="/admin/amount-setup">
         ...
         <li class="nav-item">
             <a class="nav-link" data-bs-toggle="collapse" href="/admin/#general-pages" aria-expanded="false"
